                  ...
                  <form action="{{ url('/paciente') }}" method="post" >
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="nombres_paciente" class="form-control text-uppercase">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        ...
                        <input type="text" class="rut form-control" name="rut" id="rut_paciente">
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-4" style="margin-top:10px;">
                       ...
                       <div class="col-md-4" style="margin-top:10px;">
                        ...
                        <input type="text" name="rut rut_menor" class="form-control text-uppercase">
                      </div>
                       <div class="col-md-4" style="margin-top:10px;">
